...
public final class LiquidityCalculator {
    ...
    static BigDecimal computeSpreadBps(BigDecimal bestBid, BigDecimal bestAsk) {
        ...
        return bestAsk.subtract(bestBid).divide(mid, MC).multiply(BPS_DIVISOR).setScale(4, RoundingMode.HALF_UP);
    }
    ...
    static LiquidityScore scoreFor(
            BigDecimal recommendedNotional, BigDecimal spreadBps, BigDecimal maxSlippageBps, LiquidityThresholds t) {
