...
class ExecutionDomainInvariantTest {
    ...
    void orderIntentRequiresSideExecutionTypeAndPositiveQuantity() {
        ...
        assertThatThrownBy(() ->
                        new OrderIntent(TradeSide.SHORT, ExecutionType.MARKET, BigDecimal.ZERO, null, Instant.now()))
                .isInstanceOf(IllegalArgumentException.class)
    ...
    void limitOrderIntentRequiresPositiveLimitPrice() {
        assertThatThrownBy(() ->
                        new OrderIntent(TradeSide.SHORT, ExecutionType.LIMIT, BigDecimal.ONE, null, Instant.now()))
                .isInstanceOf(IllegalArgumentException.class)
