...
class InstrumentRegistryServiceTest {
    ...
    void syncVenueToleratesDuplicateCanonicalSymbolsFromProviderAndRepository() throws Exception {
        ...
        when(provider.fetchPerpetualInstruments())
                .thenReturn(List.of(
        ...
        when(repository.findAllByVenueOrderByCanonicalSymbolAsc("gate"))
                .thenReturn(List.of(
        ...
        InstrumentRegistryService service = new InstrumentRegistryService(List.of(provider), repository, timingService);
