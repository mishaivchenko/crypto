...
class OperatorCredentialServiceResolveTest {
    ...
    private final OperatorCredentialService service =
            new OperatorCredentialService(storageProperties, cipher, repository, List.of(), new MockEnvironment());
    ...
    void returnsDecryptedCredentialsWhenEntityExists() {
        ...
        when(repository.findFirstByVenueAndMode("gate", VenueAccessMode.TESTNET))
    ...
    void returnsEmptyWhenNoEntityFound() {
        when(repository.findFirstByVenueAndMode("bybit", VenueAccessMode.TESTNET))
    ...
    private static OperatorExchangeCredentialEntity entity(
            String apiKeyCiphertext, String secretCiphertext, String passphraseCiphertext) {
