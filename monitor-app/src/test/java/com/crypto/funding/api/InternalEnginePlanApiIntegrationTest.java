...
class InternalEnginePlanApiIntegrationTest {
    ...
    void protectsEnginePlanApiWithInternalToken() throws Exception {
        ...
        mockMvc.perform(get("/internal/v1/engine/plans").header("X-Internal-Token", "test-internal-token"))
    ...
    void recordsOrderAttemptsIdempotently() throws Exception {
        ...
        org.assertj.core.api.Assertions.assertThat(orderAttemptRepository.findAll())
                .hasSize(1);
    ...
    void recordsPositionStateAndOutcomeForEngineLifecycle() throws Exception {
        ...
        org.assertj.core.api.Assertions.assertThat(armedTradeRepository
        ...
        org.assertj.core.api.Assertions.assertThat(tradeOutcomeRepository.findAll())
                .hasSize(1);
    }
