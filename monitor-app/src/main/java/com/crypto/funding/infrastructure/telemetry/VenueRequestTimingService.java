...
public class VenueRequestTimingService {
    ...
    public void recordSuccess(
            String venue, String operation, long durationNanos, long payloadSize, Integer httpStatus) {
    ...
    public List<Snapshot> snapshots() {
        return statsByKey.entrySet().stream()
    ...
    public List<Snapshot> snapshots(String venue) {
        ...
        return snapshots().stream()
                .filter(snapshot -> snapshot.venue().equals(normalizedVenue))
                .toList();
    }
    ...
    public Snapshot snapshot(String venue, String operation) {
        ...
        if (stats == null) {
            return new Snapshot(
                    normalizedVenue, normalizedOperation, 0L, 0L, 0L, 0L, 0L, null, null, null, 0L, null, null, null);
        }
