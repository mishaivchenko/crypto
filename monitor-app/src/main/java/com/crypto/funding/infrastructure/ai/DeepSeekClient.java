...
public class DeepSeekClient {
    ...
    private AdviceResult parseResponse(String responseBody) {
        try {
            ...
            AiRecommendation recommendation =
                    AiRecommendation.valueOf(raw.recommendation().trim().toUpperCase());
            ...
            return new AdviceResult(
                    recommendation, confidence, raw.reasoning(), properties.getModel(), promptTokens, completionTokens);
        } catch (Exception e) {
    ...
    @JsonIgnoreProperties(ignoreUnknown = true)
    private record RawAdvice(String recommendation, double confidence, String reasoning) {}
}
