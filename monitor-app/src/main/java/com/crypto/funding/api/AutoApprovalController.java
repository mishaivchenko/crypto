...
public class AutoApprovalController {
    ...
    public AutoApprovalController(
            ...
            AutoApprovalPipelineService pipelineService) {
    ...
    public List<AutoApprovalRuleResponse> list() {
        return ruleService.list().stream().map(AutoApprovalRuleResponse::from).toList();
    }
    ...
    public AutoApprovalRuleResponse update(@PathVariable Long id, @Valid @RequestBody AutoApprovalRuleRequest request) {
        AutoApprovalRule rule = ruleService.update(
                id,
                new UpdateAutoApprovalRuleCommand(
                        request.name(),
                        request.enabled(),
                        request.mode(),
                        request.minFundingRatePct(),
