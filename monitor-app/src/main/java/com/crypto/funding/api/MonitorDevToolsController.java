...
public class MonitorDevToolsController {
    ...
    public DevTestRunExecutionResponse runDevTestEntry(
            @PathVariable Long armedTradeId, @RequestBody(required = false) DevTestRunPhaseRequest request) {
        return devTestRunService.runPhase(
                armedTradeId, EngineExecutionTargetPhase.ENTRY, request == null ? null : request.productionConfirm());
    }
    ...
    public DevTestRunExecutionResponse runDevTestExit(
            @PathVariable Long armedTradeId, @RequestBody(required = false) DevTestRunPhaseRequest request) {
        return devTestRunService.runPhase(
                armedTradeId, EngineExecutionTargetPhase.EXIT, request == null ? null : request.productionConfirm());
    }
