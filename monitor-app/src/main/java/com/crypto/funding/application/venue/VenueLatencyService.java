...
public class VenueLatencyService {
    private static final List<String> ENTRY_LATENCY_OPERATIONS =
            List.of("order-submit", "credential-check", "metadata-sync");
    ...
    public Long estimateEntryLatencyMs(String venue) {
        ...
        List<VenueRequestTimingService.Snapshot> snapshots =
                timingService.snapshots(venue.trim().toLowerCase(Locale.ROOT));
