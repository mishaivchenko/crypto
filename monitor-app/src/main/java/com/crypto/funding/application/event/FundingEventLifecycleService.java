...
public class FundingEventLifecycleService {
    private static final Set<FundingEventStatus> EXPIRABLE_STATUSES =
            Set.of(FundingEventStatus.DISCOVERED, FundingEventStatus.ARMED);
    ...
    public int expirePastEvents() {
        ...
        int expired = 0;
        for (FundingEventEntity entity :
                fundingEventRepository.findAllByStatusInAndFundingTimeLessThanEqual(EXPIRABLE_STATUSES, now)) {
