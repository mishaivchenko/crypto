...
public class VenueDiagnosticsService {
    ...
    public VenueSummary checkCredentials(String rawVenue) {
        ...
        try {
            ...
            venueProfileService.saveCheckResult(
                    venue,
                    new com.crypto.funding.application.port.VenueCredentialCheckPort.Result(
            ...
            venueRequestTimingService.recordFailure(
                    venue, "credential-check", System.nanoTime() - startNanos, ex.getMessage());
    ...
    public List<InstrumentMetadata> listInstruments(String rawVenue, boolean activeOnly) {
        return instrumentRegistryService.listVenueInstruments(normalizeVenue(rawVenue)).stream()
    ...
    private VenueSummary buildSummary(String venue, CredentialSummary checkedSummary) {
        ...
        OperatorCredentialService.CredentialSummary credentialSummary = checkedSummary == null
