...
public class OrderAttemptRecordService {
    ...
    public OrderAttemptRecordService(
            OrderAttemptJpaRepository orderAttemptRepository, ArmedTradeJpaRepository armedTradeRepository) {
    ...
    public EngineOrderAttemptResponse record(EngineOrderAttemptRecordRequest request) {
        ...
        return orderAttemptRepository
                .findByAttemptKey(request.attemptKey())
                .map(this::toResponse)
    ...
    public List<EngineOrderAttemptResponse> listAll() {
        return orderAttemptRepository.findAllByOrderByCreatedAtDesc().stream()
                .map(this::toResponse)
                .toList();
    }
    ...
    public List<EngineOrderAttemptResponse> listByArmedTrade(Long armedTradeId) {
        ...
        return orderAttemptRepository.findAllByArmedTradeIdOrderByCreatedAtDesc(armedTradeId).stream()
                .map(this::toResponse)
                .toList();
    }
