...
public class AutoApprovalExecutor {
    ...
    public AutoApprovalExecutor(
            SignalCandidateReviewService candidateReviewService, FundingEventArmService fundingEventArmService) {
    ...
    public ArmedTrade approveAndArm(
            ...
            String actorRef) {
        SignalCandidate approved = candidateReviewService.approve(
                new ApproveSignalCandidateCommand(candidateId, venue, symbol, fundingTime, fundingRatePct, actorRef));
