...
public class EnginePlanClient {
    ...
    @Autowired
    public EnginePlanClient(
            RestClient.Builder builder, EngineProperties properties, EngineTelemetryService telemetryService) {
    ...
    public Optional<EngineVenueCredentials> fetchCredentials(String venue, String mode) {
        try {
            EngineVenueCredentials credentials = restClient
                    .get()
                    .uri(uriBuilder -> uriBuilder
    ...
    public Optional<MarkPriceResponse> fetchMarkPrice(String venue, String symbol) {
        try {
            MarkPriceResponse response = restClient
                    .get()
                    .uri(uriBuilder -> uriBuilder
                            .path("/internal/v1/engine/mark-price")
