...
class EngineTelemetryServiceTest {
    ...
    void tracksForcedRunStateSeparatelyFromScheduledRuns() {
        ...
        service.recordExecutionRun(
                false, Instant.parse("2030-01-01T00:00:00Z"), Instant.parse("2030-01-01T00:00:01Z"), 5, 2, 3, 120);
        service.recordExecutionRun(
                true, Instant.parse("2030-01-01T00:05:00Z"), Instant.parse("2030-01-01T00:05:01Z"), 8, 4, 4, 80);
    ...
    void normalizesNegativeDurationsAndIgnoresNullStatusBuckets() {
        ...
        service.recordExecutionRun(
                false, Instant.parse("2030-01-01T00:00:00Z"), Instant.parse("2030-01-01T00:00:00Z"), -1, -2, -3, -40);
