...
class EngineModuleConfigurationTest {
    ...
    void declaresExpectedImportsAndPropertyScanning() {
        assertThat(EngineModuleConfiguration.class.isAnnotationPresent(Configuration.class))
                .isTrue();

        ConfigurationPropertiesScan scan =
                EngineModuleConfiguration.class.getAnnotation(ConfigurationPropertiesScan.class);
        assertThat(scan).isNotNull();
        assertThat(scan.basePackages()).contains("com.crypto.funding.engine");

        EnableConfigurationProperties properties =
                EngineModuleConfiguration.class.getAnnotation(EnableConfigurationProperties.class);
        ...
        assertThat(imported.value())
                .containsExactlyInAnyOrder(EnginePlanClient.class, EnginePlanService.class, EngineController.class);
    }
}
