...
class EnginePlanServiceTest {
    ...
    void zeroFillsStatusesAndNormalizesBlankVenues() {
        ...
        assertThat(snapshot.planVenueBreakdown()).containsEntry("unknown", 2L).containsEntry("bybit", 1L);
    ...
    void treatsOnlyEntryAndExitWindowStatusesAsActionableAcrossFullStatusMatrix() {
        ...
        assertThat(snapshot.statusBreakdown())
        ...
        assertThat(snapshot.actionableVenueBreakdown())
                .containsExactlyInAnyOrderEntriesOf(java.util.Map.of(
                        "bybit", 1L,
                        "gate", 1L));
    }
