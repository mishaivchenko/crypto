...
class EngineExecutionServiceWarmupTest {
    ...
    void setUp() throws Exception {
        service = new EngineExecutionService(
                client, executionPort, telemetryService, clock, advancingNanos(0L, 5_000_000L), probeHttpClient);
        ...
        when(probeHttpClient.send(any(HttpRequest.class), any())).thenReturn(mock(HttpResponse.class));
    }
    ...
    void warmupRunsWhenInWindowWithProbeUrl() throws Exception {
        ...
        EngineExecutionPlan plan =
                planWithProbe(1L, "https://api.example.com/time", 3, 500L, 0L, 0L, 0L, NOW.plusMillis(250));
    ...
    void noProbeWhenProbeUrlNull() throws Exception {
        EngineExecutionPlan plan = planWithProbe(1L, null, null, null, 0L, 0L, 0L, NOW.plusMillis(250));
        when(client.listPlans(false)).thenReturn(List.of(plan));
    ...
    void noProbeOutsideWarmupWindow() throws Exception {
        ...
        EngineExecutionPlan plan =
                planWithProbe(1L, "https://api.example.com/time", 3, 500L, 0L, 0L, 0L, NOW.minusMillis(100));
        when(client.listPlans(false)).thenReturn(List.of(plan));
    ...
    void allProbesTimeoutFallsBackAndExecutionProceeds() throws Exception {
        ...
        EngineExecutionPlan plan =
                planWithProbe(1L, "https://api.example.com/time", 3, 500L, 200L, 0L, 200L, NOW.plusMillis(100));
        when(client.listPlans(false)).thenReturn(List.of(plan));
        when(probeHttpClient.send(any(HttpRequest.class), any())).thenThrow(new java.io.IOException("timeout"));
    ...
    void executionProceedsWhenAllProbesThrow() throws Exception {
        ...
        EngineExecutionPlan plan =
                planWithProbe(1L, "https://api.example.com/time", 3, 500L, 100L, 0L, 100L, NOW.minusMillis(50));
        when(client.listPlans(false)).thenReturn(List.of(plan));
        when(probeHttpClient.send(any(HttpRequest.class), any())).thenThrow(new java.io.IOException("timeout"));
    ...
    void terminalStateRemovesWarmupEntryAndAllowsRedo() throws Exception {
        EngineExecutionPlan openPlan =
                planWithProbe(1L, "https://api.example.com/time", 3, 500L, 0L, 0L, 0L, NOW.plusMillis(250));
        EngineExecutionPlan closedPlan = planWithProbeAndState(
                1L, "https://api.example.com/time", 3, 500L, 0L, 0L, 0L, NOW.plusMillis(250), ArmedTradeState.CLOSED);
        EngineExecutionPlan openPlan2 =
                planWithProbe(1L, "https://api.example.com/time", 3, 500L, 0L, 0L, 0L, NOW.plusMillis(250));
    ...
    void calibratedTriggerFallsBackToPlanLatencyWhenNoWarmup() {
        ...
        EngineExecutionPlan plan = planWithProbe(1L, null, null, null, 200L, 0L, 200L, NOW.plusMillis(100));
        when(client.listPlans(false)).thenReturn(List.of(plan));
    ...
    void calibratedTriggerTreatsNullEffectiveLatencyAsZero() {
        ...
        EngineExecutionPlan plan = planWithProbe(1L, null, null, null, null, null, null, NOW.plusMillis(100));
        when(client.listPlans(false)).thenReturn(List.of(plan));
    ...
    void futureCalibrateTriggerSkipsExecution() {
        ...
        EngineExecutionPlan plan = planWithProbe(1L, null, null, null, 100L, 0L, 100L, NOW.plusMillis(2000));
        when(client.listPlans(false)).thenReturn(List.of(plan));
    ...
    void warmupProbeRecordsLatencySampleWithWarmupOperation() throws Exception {
        ...
        ArgumentCaptor<EngineLatencySampleRequest> captor = ArgumentCaptor.forClass(EngineLatencySampleRequest.class);
    ...
    void warmupProbePostsCalibrationResultToMonitor() throws Exception {
        ...
        ArgumentCaptor<WarmupCalibrationRequest> captor = ArgumentCaptor.forClass(WarmupCalibrationRequest.class);
    ...
    void warmupWindowComputedWithNullEffectiveLatency() throws Exception {
        ...
        EngineExecutionPlan plan =
                planWithProbe(1L, "https://api.example.com/time", 3, 500L, null, null, null, NOW.plusMillis(250));
        when(client.listPlans(false)).thenReturn(List.of(plan));
    ...
    void warmupWindowUsesDefault500LeadWhenNull() throws Exception {
        ...
        EngineExecutionPlan plan =
                planWithProbe(1L, "https://api.example.com/time", 3, null, 0L, 0L, 0L, NOW.plusMillis(250));
        when(client.listPlans(false)).thenReturn(List.of(plan));
    ...
    void warmupProbeCountDefaultsTo3WhenNull() throws Exception {
        ...
        EngineExecutionPlan plan =
                planWithProbe(1L, "https://api.example.com/time", null, 500L, 0L, 0L, 0L, NOW.plusMillis(250));
        when(client.listPlans(false)).thenReturn(List.of(plan));
    ...
    void budgetDeadlineCappedAtFirstTrigger() throws Exception {
        ...
        EngineExecutionPlan plan =
                planWithProbe(1L, "https://api.example.com/time", 3, 600L, 0L, 0L, 0L, NOW.plusMillis(400));
        when(client.listPlans(false)).thenReturn(List.of(plan));
    ...
    void probeTimingSampleIsPositiveNotNegative() throws Exception {
        ...
        EngineExecutionPlan plan =
                planWithProbe(1L, "https://api.example.com/time", 1, 500L, 0L, 0L, 0L, NOW.plusMillis(250));
        when(client.listPlans(false)).thenReturn(List.of(plan));
    ...
    void buildCalibrationEmptySamplesUsesFallbackEffectiveLatency() throws Exception {
        ...
        EngineExecutionPlan plan =
                planWithProbe(1L, "https://api.example.com/time", 3, 500L, 80L, 0L, 80L, NOW.plusMillis(50));
        when(client.listPlans(false)).thenReturn(List.of(plan));
        when(probeHttpClient.send(any(HttpRequest.class), any())).thenThrow(new java.io.IOException("timeout"));
    ...
    void buildCalibrationEmptySamplesUsesFallback0WhenEffectiveLatencyNull() throws Exception {
        ...
        EngineExecutionPlan plan =
                planWithProbe(1L, "https://api.example.com/time", 3, 500L, null, null, null, NOW.plusMillis(100));
        when(client.listPlans(false)).thenReturn(List.of(plan));
        when(probeHttpClient.send(any(HttpRequest.class), any())).thenThrow(new java.io.IOException("timeout"));
    ...
    void buildCalibrationAddsManualLatencyToP50() throws Exception {
        ...
        EngineExecutionPlan plan =
                planWithProbe(1L, "https://api.example.com/time", 1, 500L, 5L, 10L, 5L, NOW.plusMillis(300));
        when(client.listPlans(false)).thenReturn(List.of(plan));
    ...
    void buildCalibrationTreatsNullManualLatencyAsZero() throws Exception {
        ...
        EngineExecutionPlan plan =
                planWithProbe(1L, "https://api.example.com/time", 1, 500L, 5L, null, 5L, NOW.plusMillis(250));
        when(client.listPlans(false)).thenReturn(List.of(plan));
    ...
    void budgetDeadlineStopsLoopWhenExhausted() throws Exception {
        ...
        Clock advancingClock = new Clock() {
            ...
            public Instant instant() {
                return Instant.ofEpochMilli(clockTick.getAndAdd(100));
            }
        };
        ...
        EngineExecutionPlan plan = planWithProbeAndState(
                99L,
    ...
    void budgetDeadlineFallsBackToFirstTriggerWhenBudgetExceedsTrigger() throws Exception {
        ...
        // With mutation: deadline=NOW+350ms; loop check returns NOW+200ms < NOW+350ms → probe fires (mutation
        // detected!)
        AtomicLong clockTick = new AtomicLong(NOW.toEpochMilli());
        Clock advancingClock = new Clock() {
            public java.time.ZoneId getZone() {
        ...
        EngineExecutionPlan plan = planWithProbeAndState(
                77L, "https://api.example.com/time", 3, 500L, 0L, 0L, 0L, NOW.plusMillis(150), ArmedTradeState.ARMED);
        when(client.listPlans(false)).thenReturn(List.of(plan));
    ...
    void calibrationAddsManualLatencyToP50ForCalibratedTrigger() throws Exception {
        ...
        EngineExecutionService svc = new EngineExecutionService(
                ...
                probeHttpClient);
        EngineExecutionPlan plan =
                planWithProbe(1L, "https://api.example.com/time", 1, 500L, 0L, 200L, 0L, NOW.plusMillis(100));
        when(client.listPlans(false)).thenReturn(List.of(plan));
