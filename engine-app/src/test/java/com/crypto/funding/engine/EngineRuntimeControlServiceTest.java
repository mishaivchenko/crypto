...
class EngineRuntimeControlServiceTest {
    ...
    void updatesLoopStateAndEnforcesMinimumInterval() {
        ...
        EngineRuntimeControlService service = new EngineRuntimeControlService(
                properties, telemetryService, Clock.fixed(Instant.parse("2030-01-01T00:00:00Z"), ZoneOffset.UTC));
        ...
        assertThat(response.executionLoopIntervalMs())
                .isEqualTo(EngineRuntimeControlService.MIN_EXECUTION_LOOP_INTERVAL_MS);
        assertThat(response.minimumExecutionLoopIntervalMs())
                .isEqualTo(EngineRuntimeControlService.MIN_EXECUTION_LOOP_INTERVAL_MS);
    }
    ...
    void returnsFalseWhenAnotherDispatcherWinsCompareAndSet() {
        ...
        properties.setExecutionLoopIntervalMs(1_000L);
        EngineTelemetryService telemetryService = new EngineTelemetryService();
        EngineRuntimeControlService service =
                new EngineRuntimeControlService(
                        properties,
                        telemetryService,
