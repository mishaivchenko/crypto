...
class AutonomousLoopIntegrationTest {
    ...
    void autonomousLoopRunsFullCycleEntryThenExit() {
        ...
        exchange.verify(
                1,
                postRequestedFor(urlEqualTo("/futures/usdt/orders"))
        ...
        monitor.verify(
                1,
                postRequestedFor(urlPathEqualTo("/internal/v1/engine/trades/" + TRADE_ID + "/state"))
        ...
        monitor.verify(
                1,
                postRequestedFor(urlEqualTo("/internal/v1/engine/outcomes"))
    ...
    private void stubMonitorForEntry() {
        ...
        monitor.stubFor(
                post(urlEqualTo("/internal/v1/engine/order-attempts")).willReturn(okJson(entryAttemptResponseJson())));
    ...
    private void stubMonitorPostsForExit() {
        monitor.stubFor(post(urlEqualTo("/internal/v1/engine/outcomes")).willReturn(okJson(outcomeResponseJson())));
    }
    ...
    private EngineExecutionService buildService() {
        ...
        LongSupplier nanos = advancingNanos(
