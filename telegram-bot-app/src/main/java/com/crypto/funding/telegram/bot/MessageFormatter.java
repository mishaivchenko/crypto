...
public final class MessageFormatter {
    ...
    public static String linksMessage(String publicUrl, EnvironmentLinksProperties envLinks) {
        ...
        boolean hasStagingStatic =
                envLinks.staging() != null && !envLinks.staging().isEmpty();
        boolean hasProdStatic =
                envLinks.production() != null && !envLinks.production().isEmpty();
